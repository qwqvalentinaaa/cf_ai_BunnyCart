import { insertNode } from 'mermaid/dist/rendering-util/rendering-elements/nodes.js';
import { interpolateToCurve } from 'mermaid/dist/utils.js';
/**
...
export declare const internalHelpers: {
    common: {
        ...
        sanitizeText: (text: string, config: import("mermaid/dist/config.type.js").MermaidConfig) => string;
        sanitizeTextOrArray: (a: string | string[] | string[][], config: import("mermaid/dist/config.type.js").MermaidConfig) => string | string[];
    ...
    getConfig: () => import("mermaid/dist/config.type.js").MermaidConfig;
    insertCluster: (elem: any, node: import("mermaid/dist/rendering-util/types.js").ClusterNode) => Promise<any>;
    ...
    labelHelper: <T extends SVGGraphicsElement>(parent: import("mermaid/dist/types.js").D3Selection<T>, node: import("mermaid/dist/rendering-util/types.js").Node, _classes?: string) => Promise<{
    ...
    log: Record<import("mermaid/dist/logger.js").LogLevel, {
        (...data: any[]): void;

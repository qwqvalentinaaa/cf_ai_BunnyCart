import type { D3Selection, MaybePromise } from 'mermaid/dist/types.js';
import type { Node, ShapeRenderOptions } from 'mermaid/dist/rendering-util/types.js';
import { anchor } from 'mermaid/dist/rendering-util/rendering-elements/shapes/anchor.js';
import { bowTieRect } from 'mermaid/dist/rendering-util/rendering-elements/shapes/bowTieRect.js';
import { card } from 'mermaid/dist/rendering-util/rendering-elements/shapes/card.js';
import { choice } from 'mermaid/dist/rendering-util/rendering-elements/shapes/choice.js';
import { circle } from 'mermaid/dist/rendering-util/rendering-elements/shapes/circle.js';
import { crossedCircle } from 'mermaid/dist/rendering-util/rendering-elements/shapes/crossedCircle.js';
import { curlyBraceLeft } from 'mermaid/dist/rendering-util/rendering-elements/shapes/curlyBraceLeft.js';
import { curlyBraceRight } from 'mermaid/dist/rendering-util/rendering-elements/shapes/curlyBraceRight.js';
import { curlyBraces } from 'mermaid/dist/rendering-util/rendering-elements/shapes/curlyBraces.js';
import { curvedTrapezoid } from 'mermaid/dist/rendering-util/rendering-elements/shapes/curvedTrapezoid.js';
import { cylinder } from 'mermaid/dist/rendering-util/rendering-elements/shapes/cylinder.js';
import { dividedRectangle } from 'mermaid/dist/rendering-util/rendering-elements/shapes/dividedRect.js';
import { doublecircle } from 'mermaid/dist/rendering-util/rendering-elements/shapes/doubleCircle.js';
import { filledCircle } from 'mermaid/dist/rendering-util/rendering-elements/shapes/filledCircle.js';
import { flippedTriangle } from 'mermaid/dist/rendering-util/rendering-elements/shapes/flippedTriangle.js';
import { forkJoin } from 'mermaid/dist/rendering-util/rendering-elements/shapes/forkJoin.js';
import { halfRoundedRectangle } from 'mermaid/dist/rendering-util/rendering-elements/shapes/halfRoundedRectangle.js';
import { hexagon } from 'mermaid/dist/rendering-util/rendering-elements/shapes/hexagon.js';
import { hourglass } from 'mermaid/dist/rendering-util/rendering-elements/shapes/hourglass.js';
import { icon } from 'mermaid/dist/rendering-util/rendering-elements/shapes/icon.js';
import { iconCircle } from 'mermaid/dist/rendering-util/rendering-elements/shapes/iconCircle.js';
import { iconRounded } from 'mermaid/dist/rendering-util/rendering-elements/shapes/iconRounded.js';
import { iconSquare } from 'mermaid/dist/rendering-util/rendering-elements/shapes/iconSquare.js';
import { imageSquare } from 'mermaid/dist/rendering-util/rendering-elements/shapes/imageSquare.js';
...
import { lean_left } from 'mermaid/dist/rendering-util/rendering-elements/shapes/leanLeft.js';
import { lean_right } from 'mermaid/dist/rendering-util/rendering-elements/shapes/leanRight.js';
import { lightningBolt } from 'mermaid/dist/rendering-util/rendering-elements/shapes/lightningBolt.js';
import { linedCylinder } from 'mermaid/dist/rendering-util/rendering-elements/shapes/linedCylinder.js';
import { linedWaveEdgedRect } from 'mermaid/dist/rendering-util/rendering-elements/shapes/linedWaveEdgedRect.js';
import { multiRect } from 'mermaid/dist/rendering-util/rendering-elements/shapes/multiRect.js';
import { multiWaveEdgedRectangle } from 'mermaid/dist/rendering-util/rendering-elements/shapes/multiWaveEdgedRectangle.js';
import { note } from 'mermaid/dist/rendering-util/rendering-elements/shapes/note.js';
import { question } from 'mermaid/dist/rendering-util/rendering-elements/shapes/question.js';
import { rect_left_inv_arrow } from 'mermaid/dist/rendering-util/rendering-elements/shapes/rectLeftInvArrow.js';
import { rectWithTitle } from 'mermaid/dist/rendering-util/rendering-elements/shapes/rectWithTitle.js';
import { roundedRect } from 'mermaid/dist/rendering-util/rendering-elements/shapes/roundedRect.js';
import { shadedProcess } from 'mermaid/dist/rendering-util/rendering-elements/shapes/shadedProcess.js';
import { slopedRect } from 'mermaid/dist/rendering-util/rendering-elements/shapes/slopedRect.js';
import { squareRect } from 'mermaid/dist/rendering-util/rendering-elements/shapes/squareRect.js';
import { stadium } from 'mermaid/dist/rendering-util/rendering-elements/shapes/stadium.js';
import { state } from 'mermaid/dist/rendering-util/rendering-elements/shapes/state.js';
import { stateEnd } from 'mermaid/dist/rendering-util/rendering-elements/shapes/stateEnd.js';
import { stateStart } from 'mermaid/dist/rendering-util/rendering-elements/shapes/stateStart.js';
import { subroutine } from 'mermaid/dist/rendering-util/rendering-elements/shapes/subroutine.js';
import { taggedRect } from 'mermaid/dist/rendering-util/rendering-elements/shapes/taggedRect.js';
import { taggedWaveEdgedRectangle } from 'mermaid/dist/rendering-util/rendering-elements/shapes/taggedWaveEdgedRectangle.js';
import { text } from 'mermaid/dist/rendering-util/rendering-elements/shapes/text.js';
import { tiltedCylinder } from 'mermaid/dist/rendering-util/rendering-elements/shapes/tiltedCylinder.js';
import { trapezoid } from 'mermaid/dist/rendering-util/rendering-elements/shapes/trapezoid.js';
import { trapezoidalPentagon } from 'mermaid/dist/rendering-util/rendering-elements/shapes/trapezoidalPentagon.js';
import { triangle } from 'mermaid/dist/rendering-util/rendering-elements/shapes/triangle.js';
import { waveEdgedRectangle } from 'mermaid/dist/rendering-util/rendering-elements/shapes/waveEdgedRectangle.js';
import { waveRectangle } from 'mermaid/dist/rendering-util/rendering-elements/shapes/waveRectangle.js';
import { windowPane } from 'mermaid/dist/rendering-util/rendering-elements/shapes/windowPane.js';
import { erBox } from 'mermaid/dist/rendering-util/rendering-elements/shapes/erBox.js';
import { classBox } from 'mermaid/dist/rendering-util/rendering-elements/shapes/classBox.js';
import { requirementBox } from 'mermaid/dist/rendering-util/rendering-elements/shapes/requirementBox.js';
import { kanbanItem } from 'mermaid/dist/rendering-util/rendering-elements/shapes/kanbanItem.js';
import { bang } from 'mermaid/dist/rendering-util/rendering-elements/shapes/bang.js';
import { cloud } from 'mermaid/dist/rendering-util/rendering-elements/shapes/cloud.js';
import { defaultMindmapNode } from 'mermaid/dist/rendering-util/rendering-elements/shapes/defaultMindmapNode.js';
import { mindmapCircle } from 'mermaid/dist/rendering-util/rendering-elements/shapes/mindmapCircle.js';

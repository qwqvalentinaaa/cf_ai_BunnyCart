...
import type { DiagramDefinition, DiagramMetadata } from 'mermaid/dist/diagram-api/types.js';
...
export declare class Diagram {
    ...
    getParser(): import("mermaid/dist/diagram-api/types.js").ParserDefinition;
    getType(): string;
}

import {
  ...
  createParser
} from "./chunk-4ENGM5Y2.js";
import {
  external_exports
} from "./chunk-LM3UEMPC.js";
import {
  __commonJS,
  __toESM
...
// node_modules/agents/dist/ai-types-CrMqkwc_.js
...
// node_modules/agents/dist/client-B3SR12TQ.js
...
// node_modules/agents/dist/do-oauth-client-provider-CwqK5SXm.js
...
var CfWorkerJsonSchemaValidator = class {
  ...
  constructor(options) {
    var _a2, _b;
    this.shortcircuit = (_a2 = options === null || options === void 0 ? void 0 : options.shortcircuit) !== null && _a2 !== void 0 ? _a2 : true;
  ...
  setRequestHandler(requestSchema, handler) {
    ...
    if (method === "elicitation/create") {
      const wrappedHandler = async (request, extra) => {
        ...
        if (((_a2 = this._capabilities.elicitation) === null || _a2 === void 0 ? void 0 : _a2.applyDefaults) && validatedResult.action === "accept" && validatedResult.content && validatedRequest.data.params.requestedSchema) {
          try {
...
function extractWWWAuthenticateParams(res) {
  ...
  const scope = (scopeMatch === null || scopeMatch === void 0 ? void 0 : scopeMatch[1]) || void 0;
  return {
    resourceMetadataUrl,
    scope
  };
...
// node_modules/agents/dist/client-BZq9qau2.js
  ...
  async discover(options = {}) {
    ...
    try {
      const timeoutPromise = new Promise((_, reject) => {
        timeoutId = setTimeout(() => reject(new Error(`Discovery timed out after ${timeoutMs}ms`)), timeoutMs);
      });
...
var defaultClientOptions = { jsonSchemaValidator: new CfWorkerJsonSchemaValidator() };
var MCPClientManager = class {
  ...
  */
  async ensureJsonSchema() {
    if (!this.jsonSchema) {
      const { jsonSchema } = await import("./dist-FE3V3CLB.js");
...
// node_modules/agents/dist/src-D_KKH_4c.js
...
// node_modules/agents/dist/src-D_KKH_4c.js
var genericObservability = { emit(event) {
  if (isLocalMode()) {
  ...
  */
  async replyToEmail(email, options) {
    return this._tryCatch(async () => {
      ...
      const { createMimeMessage } = await import("./mimetext.node.es-XVFVFAUL.js");
...
//# sourceMappingURL=chunk-6BEZ37YT.js.map
